...
const DEFAULT_COLUMNS: ColumnConfig[] = [
  ...
  { key: 'totalSolicitadoCLP', label: 'Total Solicitado CLP', visible: false, group: 'solicitada', order: 8 },
  ...
  { key: 'totalStockCLP', label: 'Total Stock CLP', visible: false, group: 'stock', order: 11 },
  { key: 'valorUnitario', label: 'Valor Unitario', visible: true, group: 'general', order: 12 },
  { key: 'totalUSD', label: 'Total General USD', visible: true, group: 'general', order: 13 },
  { key: 'totalCLP', label: 'Total General CLP', visible: false, group: 'general', order: 14 },
  { key: 'acciones', label: 'Acciones', visible: true, required: true, group: 'general', order: 15 },
];
